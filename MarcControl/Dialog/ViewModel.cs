...
namespace LibraryStudio.Forms.MarcControlDialog
{
    ...
    {
        private MarcControl _instance;
        private ICustomTypeDescriptor _originalDescriptor;
        public ViewModel(MarcControl instance,
        ...
        public static ViewModel DressUp(MarcControl instance)
        {
        ...
        public override PropertyDescriptorCollection GetProperties(Attribute[] attributes)
        {
            ...
            var bettered = properties.Select(pd =>
            {
                ...
                // 从 .Name 找到 readonly 的应有值
                {
                    ...
                    return TypeDescriptor.CreateProperty(typeof(MarcControl), pd, attribs.ToArray());
                }
